...
const Home = () => {
  ...
  let [featuredGuides, setFeaturedGuides] = useState([]);
  ...
  async function fetchFeaturedGuides() {
    const blogs = await getFeaturedGuides();
    setFeaturedGuides(blogs.featuredGuides);
  }
              ...
              <div className="blog-container">
                {featuredGuides.length ? (
                  featuredGuides.map((guide) => {
                    // console.log("featuredGuides:", featuredGuides);
                    return (
                      <div
                        className="blog-div"
                        id="blog-d"
